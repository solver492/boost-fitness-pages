...
const fr: Dict = {
  ...
  "shop.title": "Toute la boutique Go Fitness",
  "shop.subtitle": "Protéines, gainers, créatine, pre-workout, vitamines et packs. Livraison gratuite au Maroc, paiement à la livraison.",
  "card.see": "Voir",
...
const en: Dict = {
  ...
  "shop.title": "Go Fitness Full Store",
  "shop.subtitle": "Proteins, gainers, creatine, pre-workout, vitamins & packs. Free delivery in Morocco, cash on delivery.",
  "card.see": "View",
...
const ar: Dict = {
  ...
  "shop.title": "المتجر الكامل ديال Go Fitness",
  "shop.subtitle": "بروتين، غاينر، كرياتين، ما قبل التمرين، فيتامينات وباكات. توصيل مجاني فالمغرب، الخلاص عند التسليم.",
  "card.see": "شوف",
